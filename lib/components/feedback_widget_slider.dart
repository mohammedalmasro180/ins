    ...
    class FeedBackWidgetSlider extends StatefulWidget {
      final fd.Feedback feedback;
      final bool isOpen;
      const FeedBackWidgetSlider({
        Key? key,
        required this.feedback, this.isOpen=false,
      }) : super(key: key);

      @override
      State<FeedBackWidgetSlider> createState() => _FeedBackWidgetSliderState();
    }

    class _FeedBackWidgetSliderState extends State<FeedBackWidgetSlider> {
